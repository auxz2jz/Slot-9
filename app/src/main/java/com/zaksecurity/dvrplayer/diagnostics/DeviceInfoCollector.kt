...
object DeviceInfoCollector {
    ...
    fun collect(
        ...
        return linkedMapOf(
            ...
            "availableProcessors" to
                Runtime.getRuntime()
                    .availableProcessors()
                    .toString(),
            "memoryClassMb" to
                activityManager.memoryClass.toString(),
            "largeMemoryClassMb" to
                activityManager.largeMemoryClass.toString(),
            "lowRamDevice" to
                activityManager.isLowRamDevice.toString(),
            "availableMemoryBytes" to
